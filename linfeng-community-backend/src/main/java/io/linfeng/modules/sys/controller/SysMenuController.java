...
import io.linfeng.modules.sys.param.SysMenuParam;
...
public class SysMenuController extends AbstractController {
	...
	public R save(@RequestBody SysMenuParam param){
	...
	public R update(@RequestBody SysMenuParam param){
		ValidatorUtils.validateEntity(param);
		
		//转换为实体类
		SysMenuEntity menu = new SysMenuEntity();
		menu.setMenuId(param.getMenuId());
		menu.setParentId(param.getParentId());
		menu.setName(param.getName());
		menu.setUrl(param.getUrl());
		menu.setPerms(param.getPerms());
