...
public class RedisUtils {
     ...
     * @param num
     */
    public void hashChange(String key,String field,int num){
     ...
     * @param num
     */
    public void hashAdd(String key,String field,String num){
        redisTemplate.opsForHash().put(key, field, num);
    }
