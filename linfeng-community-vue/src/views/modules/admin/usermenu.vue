    ...
    <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter="getDataList()">
            <el-form-item>
                ...
                >
                <el-button
                    v-if="isAuth('admin:usermenu:delete')"
                    type="danger"
                    @click="deleteHandle()"
                ...
                >
                 <el-button
                    v-if="isAuth('admin:usermenu:update')"
                    type="warning"
                    @click="downHandle()"
                    :disabled="dataListSelections.length <= 0"
                    >批量下架</el-button
...
function getDataList() {
    ...
    proxy
        .$http({
            url: proxy.$http.adornUrl("/admin/usermenu/list"),
            method: "get",
...
function deleteHandle(id) {
    ...
    ElMessageBox.confirm(
        ...
        .then(() => {
            proxy
                .$http({
                    url: proxy.$http.adornUrl("/admin/usermenu/delete"),
                    method: "post",
...
function downHandle(id) {
    ...
    ElMessageBox.confirm(
        ...
        .then(() => {
            proxy
                .$http({
                    url: proxy.$http.adornUrl("/admin/usermenu/downBatch"),
                    method: "post",
                    data: proxy.$http.adornData(ids, false),
                })
                .then(({ data }) => {
...
function upHandle(id) {
    ...
    ElMessageBox.confirm(
        ...
        .then(() => {
            proxy
                .$http({
                    url: proxy.$http.adornUrl("/admin/usermenu/upBatch"),
                    method: "post",
                    data: proxy.$http.adornData(ids, false),
                })
                .then(({ data }) => {
