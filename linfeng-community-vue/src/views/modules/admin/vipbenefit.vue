<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter="getDataList()">
      <el-form-item>
        <el-button
          v-if="isAuth('admin:vipbenefit:save')"
          type="primary"
          @click="addOrUpdateHandle()"
          >新增</el-button
        >
        <el-button
          v-if="isAuth('admin:vipbenefit:delete')"
          type="danger"
          @click="deleteHandle()"
...
<script setup>
import AddOrUpdate from "./vipbenefit-add-or-update";
...
function getDataList() {
  ...
  proxy
    .$http({
      url: proxy.$http.adornUrl("/admin/vipbenefit/list"),
      method: "get",
...
function deleteHandle(id) {
  ...
  ElMessageBox.confirm(
    ...
    .then(() => {
      proxy
        .$http({
          url: proxy.$http.adornUrl("/admin/vipbenefit/delete"),
          method: "post",
