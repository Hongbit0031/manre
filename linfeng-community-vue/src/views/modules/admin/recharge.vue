<template>
    <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter="getDataList()">
            <el-form-item>
                <el-button
                    v-if="isAuth('admin:recharge:save')"
                    type="primary"
                    @click="addOrUpdateHandle()"
                    >新增</el-button
                >
                <el-button
                    v-if="isAuth('admin:recharge:delete')"
                    type="danger"
                    @click="deleteHandle()"
...
function getDataList() {
    ...
    proxy
        .$http({
            url: proxy.$http.adornUrl("/admin/recharge/list"),
            method: "get",
...
function deleteHandle(id) {
    ...
    ElMessageBox.confirm(
        ...
        .then(() => {
            proxy
                .$http({
                    url: proxy.$http.adornUrl("/admin/recharge/delete"),
                    method: "post",
